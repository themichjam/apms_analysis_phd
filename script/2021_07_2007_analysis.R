...
# record plots as animation
gg_record(
  dir = file.path(tempdir(),"plots"), # where to save the recording
  device = "png", # device to use to save images
  width = , # width of saved image
  height = , # height of saved image
...
# plot animation playback
gg_playback(
  name = file.path(tempdir(),"plots","vignette_gif.gif"),
