...
1. Why are factor levels showing as NULL?
2. Running drop_na() after converting unwanted typos/answers results in while df showing 0 observations?
3. Something about sorting unwanted answers makes the unweighted plots show as nothing when run. 
4. Nicks advice on weights/survey commands still to be run.
...
subset_pms07 <- subset_pms07 %>%
  ...
  type.convert(as.is = TRUE) #%>% drop_na() running the drop_na() results in 0 observations
